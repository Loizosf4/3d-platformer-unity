...
public class PrefabPlacementTool : EditorWindow
{
    ...
    private string[] folderFilters = new string[] { "Assets/Prefabs" };
    ...
    private void OnGUI()
    {
        ...
        {
            EditorGUILayout.HelpBox("No prefabs found. Make sure you have prefabs in Assets/Prefabs folder.", MessageType.Info);
        }
        else
        {
        ...
        EditorGUILayout.LabelField("• Click in Scene view to place instances", EditorStyles.wordWrappedLabel);
        EditorGUILayout.LabelField("• Hold Shift + Click for rapid placement", EditorStyles.wordWrappedLabel);
